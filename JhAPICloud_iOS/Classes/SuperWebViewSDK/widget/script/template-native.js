...
template.helper('toFixed',function(num,s){
    if(num){
...
template.helper('isNotBlack',function(data){
...
template.helper('formatFloat',function (num, precision) {
    if (precision < 0 || isNaN(parseInt(num)) || parseInt(num) == num)
        return num;
